            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: GestureDetector(
                  onTap: onCancel ?? () => controller.clear(),
                  child: Icon(
                    Icons.cancel,
...
class _DiscoverScreenState extends State<DiscoverScreen>
  ...
  @override
  void initState() {
    _tabController.addListener(_closeKeyboard);
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        elevation: 1,
        title: ChallengeSearch(
          controller: _textEditingController,
          onChanged: _onSearchChanged,
          onSubmitted: () => _onSearchSubmitted(_textEditingController.text),
        ),
        bottom: TabBar(
